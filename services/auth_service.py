...
def get_current_user_optional(
    ...
    """Extract user from Bearer header, cookie, query param, or session."""
    token = None
...
def authenticate_websocket(
    ...
    """Authenticate WebSocket connection using query param, cookie, or session."""
    ...
    if session_cookie:
        # Fallback to default admin if session cookie exists
