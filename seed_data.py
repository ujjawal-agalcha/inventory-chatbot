...
from mongo_db import get_products_collection, init_mongo_indexes

logger = logging.getLogger("seed_data")

# ============================================================
# LEGITIMATE ELECTRONIC EQUIPMENT INVENTORY (PERMANENT)
# ============================================================
...
def seed_mongo_inventory():
    ...
    from services.excel_import_service import normalize_text, extract_keywords_and_aliases
    ...
    for item in ELECTRONIC_COMPONENTS_DATA:
        ...
        if existing:
            # Ensure permanent source_type is set and data is up to date
...
def seed_inventory():
    """
    Seed both SQLite (for legacy compatibility) and MongoDB (for real application).
    """
    db = SessionLocal()
    try:
        added = 0
